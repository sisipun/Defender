...
public class CommonAssetsStorage {
    ...
    public boolean init(TextureAtlas atlas) {
        ...
        commonAssets = new CommonAssets(atlas, "road_vertical_part", "road_horizontal_part",
                ...
                "grass_part", "water_top_part", "water_bottom_part", "water_left_part",
                "water_right_part", "water_left_top", "water_right_top", "water_left_bottom",
                "water_right_bottom", "water_part", "house_part", "zone", "menu_background",
                "health", "health_background", "timer", "timer_background", "generate_enemy",
                "increase_balance");
        return true;
    }
